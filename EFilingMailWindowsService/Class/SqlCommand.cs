                ...
                string strSql = "WITH CIFList(CIF_ID) As\n"
                                ...
                                + "(\n"
                                 + "Select cutl.T_MNEMONIC, cutl.T_EMAIL_SIGN_1, cutl.T_EMAIL_1\n"
                                  ...
                                  + "Where EXISTS(Select RECID From [ODS2-DB].[ODS2_DBU].[dbo].[TMB_CONS_STMT_CONF_C1] where CUST_ND_STMT_TYPE <> 'STMT_209')\n"
                                ...
                                + "(\n"
                                    ...
                                    + "And LEFT(ct.TXN_ID, 1) not in('M', 'N', 'L') And (len(ct.TRANS_STATE) = 0 or ct.TRANS_STATE ='LIVE')\n"
                                + ")\n"
